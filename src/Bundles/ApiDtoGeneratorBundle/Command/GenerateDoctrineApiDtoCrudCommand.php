 ...
 */
class GenerateDoctrineApiDtoCrudCommand extends GenerateDoctrineCommand
{
    ...
    {
        $this
            ->setName('doctrine:generate:api-dto-crud')
            ->setAliases(array('generate:doctrine:api:dto_crud'))
            ->setDescription('Generates a API DTO CRUD based on a Doctrine entity')
